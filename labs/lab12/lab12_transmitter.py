...
class lab12_transmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB_xmt_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB_xmt_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab12_transmitter")
        ...
        self._volume_range = Range(0, 20.0, 0.1, 10, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, carrier_freq, 1.0, 0, 0)
...
def main(top_block_cls=lab12_transmitter, options=None):
