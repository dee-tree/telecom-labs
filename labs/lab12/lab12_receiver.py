...
# Title: SSB_rcv_test
# Author: Dmitriy Sokolov (Barry Duggan)
...
class lab12_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB_rcv_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB_rcv_test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab12_receiver")
        ...
        self._tuning_win = RangeWidget(self._tuning_range, self.set_tuning, "Tuning", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'W:\\edu\\telecom-labs\\labs\\lab12\\ssb_lsb_256k_complex2.dat', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self._bfo_range = Range(0, 3000, 10, 1500, 200)
        self._bfo_win = RangeWidget(self._bfo_range, self.set_bfo, "Fine tuning", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._bfo_win)
        self.audio_sink_0 = audio.sink(32000, '', True)
        self.analog_sig_source_x_1 = analog.sig_source_f(32000, analog.GR_COS_WAVE, 1500, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(32000, analog.GR_SIN_WAVE, 1500, 1, 0, 0)
...
def main(top_block_cls=lab12_receiver, options=None):
